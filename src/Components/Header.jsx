...
// Images
// import Hero_image from '../assets/Meeting.svg';
// Icons
        ...
        <header className='hero_section'>
            <div className='hero_text_section'>
                <div className="hero_text_1 mb-5">
                    <h1>BEST FINANCIAL SOLUTIONS</h1>
                    <p><AiOutlineLine />For Your Business</p>
                </div>
                <div className="hero_text_2 mb-4">
                    <p>Finaccs provides quality financial advisory</p>
                    <p>services to businesses all over the World.</p>
                </div>
                <button className='btn btn-primary exploreBtn mb-4'>Explore<AiOutlineArrowRight className='exploreIcon' /></button>
